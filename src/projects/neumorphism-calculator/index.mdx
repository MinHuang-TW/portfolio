...
projectStack: [CSS3, ES6, PWA]
projectBrief: A simple neumorphism calculator built by purely vanilla javascript. The project is a progressive web application (PWA), therefore offline mode is supported.
