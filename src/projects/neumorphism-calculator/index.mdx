...
The project was developed in purely _vanilla javascript_ while the animation was created with _CSS_. Besides, _Service Worker_ was utilized to turn this project into a _progressive web application_(PWA) and make it work offline. At the end, the project was deployed on _Netlify_.
