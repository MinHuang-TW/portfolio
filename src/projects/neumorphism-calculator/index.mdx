...
projectStack: [CSS3, Js ES6, Service worker]
projectBrief: A simple calculator is built by purely vanilla javascript and it utilizes immediate execution logic. Offline mode is also supported since this project is a progressive web application (PWA).
...
<TitleAnchored>Current Problem</TitleAnchored>
...
<div class="calculator-container">
  ...
  <div>
    <TitleAnchored>Live Demo</TitleAnchored>
    <iframe
      class="calculator"
      name="js calculator"
