...
projectStack: [HTML5, CSS3, ES7, React, LocalStorage, Service workers, PWA]
...
The COVID-19 Tracker is a _single-page application(SPA)_ and _progressive web application(PWA)_ developed in _HTML_, _CSS_, _React.js_ and _Service Workers_ and deployed on _Netlify_.
