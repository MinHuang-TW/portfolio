...
projectRole: [UX Researcher, UX/ UI Designer, Fullstack Developer]
projectStack: [Html5/ CSS3, React, Redux, Firebase cloud, Firbase auth]
...
<div class='iframe-container' style={{ marginBottom: '-2.5rem' }}>
<div>
