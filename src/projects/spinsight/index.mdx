...
projectRole: [UX Researcher, UX/ UI Designer, Developer]
...
This graduation project is conducted with the cooperation of _OfficeVitae_. The shared goal is to propose design solutions in pursuit of sustainable millennial employees' vitality promotion at work.

<div class='iframe-container'>
<div>
<TitleAnchored gutterTop>Summery</TitleAnchored>
...
SpInsight(see LIVE DEMO) is a platform encouraging millennial employees to explore non-work-related aspects of colleagues with the aim of taking a short mental switch from work. It potentially triggers more face-to-face non-work-related interaction with colleagues, which enhances vitality at work.
...
The project starts with the <a href='#Research Findings'>**User-centric Research**</a> with millennial employees into effective vitality strategies at work. Then, the person-product interaction facilitating the long-term vitality goal is explored by means of iterative <a href='#Insights From Research Through Design'>**Research Through Design**</a>. At the end, a digital social <a href='#Conceptualization'>**Vitality Platform**</a> is created in pursuit of sustainable employee vitality promotion at work, and <a href='#Final Evaluation'>**Evaluated**</a> in the actual context.
...
The <a href="#Summery">**Final Prototype**</a> was evaluated with 37 participants in
four companies for a week.

The concept worked well in the group of 12 interns and it potentially triggered more face-to-face non-work-related interaction with colleagues, which in turn enhances vitality at work. However, the rest of participants showed less motivation because of less motivating questions and lack of triggers.
