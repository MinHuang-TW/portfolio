...
projectStack: [HTML5, CSS3, JS ES7, React, MongoDB, Express, Node.js]
...
import checkSummery from "./expenseTracker_video_transactions.gif"
...
<div class='figure-container gif-container'>
  <figure>
    <img src={addNew} alt="add new transaction" />
    <figcaption>Adding and edit a transaction</figcaption>
  </figure>
  <figure>
    <img src={checkSummery} alt="check summery of transactions" />
    <figcaption>Check record and summery of the day, week, etc.</figcaption>
  </figure>
</div>
